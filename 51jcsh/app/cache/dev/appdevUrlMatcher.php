...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // user
        if (0 === strpos($pathinfo, '/user') && preg_match('#^/user/(?<name>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Acme\\UserBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'user'));
        }
